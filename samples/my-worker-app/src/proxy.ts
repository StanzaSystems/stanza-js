...
export default {
  async guard(
    ...
    if (key === null) {
      ...
      return new Response('407 Proxy Authentication Required', {
        status: 407,
    ...
    const getTokenRequestPayload =
      '{"selector":{"environment":"dev","guardName":"StressTest","featureName":""}}';
    ...
    const getTokenResponseJSON: GetTokenResponse = JSON.parse(
