...
type RenderChildrenFn = (options: { disabled: boolean, message: string }) => React.ReactNode
...
export function WithStanzaFeature (props: { children: RenderChildrenFn, name: string, fallback?: never }): React.ReactNode
export function WithStanzaFeature (props: { children: React.ReactNode, name: string, fallback?: FallbackFn }): React.ReactNode
