...
describe('addCookie', () => {
  ...
  it('should append a cookie if one already exists - string', () => {
    expect(addCookie('existingCookie', 'testCookie')).toEqual(['existingCookie', 'testCookie'])
  })
  ...
  it('should append a cookie if more than one already exists', () => {
    expect(addCookie(['existingCookie1', 'existingCookie2'], 'testCookie')).toEqual(['existingCookie1', 'existingCookie2', 'testCookie'])
  })
  ...
  it('should NOT append an empty cookie if more than one already exists', () => {
    expect(addCookie(['existingCookie1', 'existingCookie2'], '')).toEqual(['existingCookie1', 'existingCookie2'])
  })
})
