/* eslint-disable */
/*
 * Original file: https://github.com/open-telemetry/opentelemetry-js/blob/3e5929132129ed6022adbd05d085b998cb03e3d5/packages/opentelemetry-context-async-hooks/test/AsyncHooksContextManager.test.ts
 *
 * This file was modified:
 * * remove testing of AsyncHooksContextManager
 * * rewrite test to use Promise instead of done callback as vitest doesn't support that anymore
 * */
/*
...
for (const contextManagerClass of [AsyncLocalStorageContextManager]) {
  describe(contextManagerClass.name, () => {
    ...
    describe('.with()', () => {
      ...
      it('async function called from nested "with" sync function should return nested context', () =>
        new Promise<void>((done) => {
      ...
      it('should not loose the context', () =>
        new Promise<void>((done) => {
          const scope1 = '1' as any;
      ...
      it('should works with multiple concurrent operations', () =>
        new Promise<void>((done) => {
          const scope1 = '1' as any;
          const scope2 = '2' as any;
          const scope3 = '3' as any;
      ...
      it('should work with timers using the same timeout', () =>
        new Promise<void>((done) => {
          let cnt = 3;
          function countDown() {
            cnt--;
    ...
    describe('.bind(function)', () => {
      ...
      it('should fail to return current context with async op', () =>
        new Promise<void>((done) => {
          const context = ROOT_CONTEXT.setValue(key1, 1);
          const fn = contextManager.bind(context, () => {
            assert.strictEqual(contextManager.active(), context);
    ...
    describe('.bind(event-emitter)', () => {
      ...
      it('should return current context and removeListener (when enabled)', () =>
        new Promise<void>((done) => {
          const ee = new EventEmitter();
          const context = ROOT_CONTEXT.setValue(key1, 1);
      ...
      it('should return current context and removeAllListener (when enabled)', () =>
        new Promise<void>((done) => {
          const ee = new EventEmitter();
          const context = ROOT_CONTEXT.setValue(key1, 1);
          const patchedEE = contextManager.bind(context, ee);
      ...
      it('should return current context and removeAllListeners (when enabled)', () =>
        new Promise<void>((done) => {
          const ee = new EventEmitter();
          const context = ROOT_CONTEXT.setValue(key1, 1);
          const patchedEE = contextManager.bind(context, ee);
      ...
      it('should not return current context with async op', () =>
        new Promise<void>((done) => {
          const ee = new EventEmitter();
          const context = ROOT_CONTEXT.setValue(key1, 1);
          const patchedEE = contextManager.bind(context, ee);
