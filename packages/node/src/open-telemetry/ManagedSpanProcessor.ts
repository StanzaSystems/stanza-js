...
import { type ReadableSpan, type Span, type SpanProcessor } from '@opentelemetry/sdk-trace-node'
...
export class ManagedSpanProcessor implements SpanProcessor {
  ...
  onStart (span: Span, parentContext: Context): void {
    this.spanProcessorManager.getSpanProcessor(parentContext).onStart(span, parentContext)
  }
