...
const REQUEST_TIMEOUT_SYMBOL: unique symbol = Symbol.for('[Stanza SDK Internal] Request timeout')
describe('requestTimeout', () => {
  ...
  it('should fallback to default after module and globalThis resets', async () => {
    ...
    const { STANZA_REQUEST_TIMEOUT: STANZA_REQUEST_TIMEOUT_1 } = await import('./requestTimeout')
