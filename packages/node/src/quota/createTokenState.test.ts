...
describe('createTokenState', function () {
  ...
  describe('hasToken', function () {
    ...
    ] satisfies TokenQuery[])(
      'should have token if it was added and matching query is provided - %o',
      function (query) {
        const tokenState = createTokenState();
    ...
    it.each([
      ...
      'should NOT have token that does not match query - %o',
      function (query) {
        const tokenState = createTokenState();
    ...
    it.each([
      ...
      'should NOT have token if it was added and matching query is provided but it is expired - %o',
      function (query) {
        const tokenState = createTokenState();
  ...
  describe('popToken', function () {
    ...
    it.each([
      ...
      'should return token if it was added and matching query is provided - %o',
      function (query) {
        const tokenState = createTokenState();
    ...
    it.each([
      ...
      'should return token more than once if it was added and matching query is provided - %o',
      function (query) {
        const tokenState = createTokenState();
    ...
    it.each([
      ...
      'should return null if no toke does not match query - %o',
      function (query) {
        const tokenState = createTokenState();
    ...
    it.each([
      ...
      'should return null if it was added and matching query is provided but it is expired - %o',
      function (query) {
        const tokenState = createTokenState();
