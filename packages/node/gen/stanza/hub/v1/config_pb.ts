...
export class GetDecoratorConfigRequest extends Message<GetDecoratorConfigRequest> {
   ...
   *
   * @generated from field: stanza.hub.v1.DecoratorServiceSelector selector = 2;
   */
  selector?: DecoratorServiceSelector;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "selector", kind: "message", T: DecoratorServiceSelector },
  ]);
