...
export class UpdateStreamsRequest extends Message<UpdateStreamsRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "requests", kind: "message", T: StreamRequest, repeated: true },
    { no: 4, name: "ended", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UpdateStreamsRequest {
    return new UpdateStreamsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UpdateStreamsRequest {
    return new UpdateStreamsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UpdateStreamsRequest {
    return new UpdateStreamsRequest().fromJsonString(jsonString, options);
  }

  static equals(a: UpdateStreamsRequest | PlainMessage<UpdateStreamsRequest> | undefined, b: UpdateStreamsRequest | PlainMessage<UpdateStreamsRequest> | undefined): boolean {
...
export class UpdateStreamsResponse extends Message<UpdateStreamsResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "results", kind: "message", T: StreamResult, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UpdateStreamsResponse {
    return new UpdateStreamsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UpdateStreamsResponse {
    return new UpdateStreamsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UpdateStreamsResponse {
    return new UpdateStreamsResponse().fromJsonString(jsonString, options);
  }

  static equals(a: UpdateStreamsResponse | PlainMessage<UpdateStreamsResponse> | undefined, b: UpdateStreamsResponse | PlainMessage<UpdateStreamsResponse> | undefined): boolean {
...
export class StreamRequest extends Message<StreamRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "priority_boost", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
...
export class StreamResult extends Message<StreamResult> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "allocated_weight", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): StreamResult {
    return new StreamResult().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): StreamResult {
    return new StreamResult().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): StreamResult {
    return new StreamResult().fromJsonString(jsonString, options);
  }

  static equals(a: StreamResult | PlainMessage<StreamResult> | undefined, b: StreamResult | PlainMessage<StreamResult> | undefined): boolean {
