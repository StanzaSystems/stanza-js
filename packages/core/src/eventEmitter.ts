...
export interface StanzaChangeEmitter<StanzaEvent> {
  addChangeListener: (callback: StanzaListener<StanzaEvent, void | Promise<void>>) => () => void
  removeChangeListener: (callback: StanzaListener<StanzaEvent, void | Promise<void>>) => void
...
export class StanzaChangeTarget<StanzaEvent> implements StanzaChangeEmitter<StanzaEvent> {
  ...
  addChangeListener (callback: StanzaListener<StanzaEvent, void | Promise<void>>) {
    this.emitter.on('change', callback)
    return () => { this.emitter.off('change', callback) }
  }

  removeChangeListener (callback: StanzaListener<StanzaEvent, void | Promise<void>>) {
